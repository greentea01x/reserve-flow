...
| D-31 | สถาปัตยกรรม deploy (ประวัติ) | แยก frontend ออกจาก Fly API/worker เป็นคนละ deployment boundary | ลดภาระ OS/DBA และคง worker แบบ always-on | **แทนที่โดย D-33 (2026-08-27)** | เก็บเฉพาะสาระของ decision เดิมโดยไม่แสดง provider ที่เลิกใช้; ห้ามใช้เป็น deployment/runbook ปัจจุบัน |
